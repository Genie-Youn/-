...
<link rel="stylesheet" href="/admin/css/adder/enrollPage-style-proto.css">
<style type="text/css">
.modern {
...
<!-- 							경로가 여기있다 -->
							<form method="post" name='formsEditor' action='/calendar/calendarInsert.do' modelAttribute=info>
								...
								<div id="adder_info_wrapper">
									<ul>
										...
										<li class='date-range-input'><input class="from-date-input" placeholder="시작날짜" type="text" name="startDate"> ~ <input class="to-date-input" placeholder="종료날짜" type="text" name="endDate"></li>
									</ul>
								</div>
								...
								<input type="hidden" id="hidden_input_type" name="type" value=0>
<!-- 								추가된 부분일세								 -->
								...
								<div class="option-wrapper">
									<div class="row">
											...
											<div class="col-xs-8">
												<input type="radio" name="popupEnable" value="00"/> 사용&nbsp;&nbsp;
												<input type="radio" name="popupEnable" value="01"/> 중지
											</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-xs-4">
											<input type="radio" name="alarmEnable" value="00"/> 사용&nbsp;&nbsp;
											<input type="radio" name="alarmEnable" value="01"/> 중지
										</div>
